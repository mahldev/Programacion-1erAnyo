...
public class ContendorRegistros implements Serializable {
    ...
    public Double tempMaxima() {
        ...
        // }
        // return null;
        return registros.stream().mapToDouble(r -> r.getTemperatura()).max().orElse(0);
    }
    ...
    public Double tempMinima() {
        ...
        // }
        // return null;
        return registros.stream().mapToDouble(r -> r.getTemperatura()).min().orElse(0);
    }
    ...
    public Double promedio() {
        ...
        return registros.stream().mapToDouble(r -> r.getTemperatura()).average().orElse(0);
    }
